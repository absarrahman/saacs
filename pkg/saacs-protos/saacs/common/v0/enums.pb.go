...
var file_saacs_common_v0_enums_proto_rawDesc = string([]byte{
...
var (
	...
	file_saacs_common_v0_enums_proto_rawDescData []byte
)

func file_saacs_common_v0_enums_proto_rawDescGZIP() []byte {
	file_saacs_common_v0_enums_proto_rawDescOnce.Do(func() {
		file_saacs_common_v0_enums_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_saacs_common_v0_enums_proto_rawDesc), len(file_saacs_common_v0_enums_proto_rawDesc)))
	})
...
func file_saacs_common_v0_enums_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_saacs_common_v0_enums_proto_rawDesc), len(file_saacs_common_v0_enums_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
